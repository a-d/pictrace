...
| PT12 | P4 | Scaling: single-page payload — **landed 2026-09-20** (batches 1+2: merge wrappers, trims, whitespace collapse, fragment compaction, baked backdrop, `content-visibility`; −20 % raw / −12.6 % gzip on the single page, commits `1f1b98c`, `69ad0b1`, `4681a48`); the split strategy shipped as PT16 (index −94 %) |
...
| PT12 | [`.hermes/plan/PT12-scaling-architecture.md`](.hermes/plan/PT12-scaling-architecture.md) — implemented 2026-09-20 (commits `1f1b98c`, `69ad0b1`, `4681a48`); split strategy → PT16 |
